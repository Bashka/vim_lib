...
" Last Change: 2015-01-07 11:47:10
...
"" }}}
function! s:TestObject.testExpand_saveParentLink() " {{{
...
" @covers vim_lib#base#Object#.expand
"" }}}
function! s:TestObject.testExpand_copyMethods() " {{{
...
" @covers vim_lib#base#Object#.expand
"" }}}
function! s:TestObject.testExpand_definedSubclass() " {{{
...
"" }}}
function! s:TestObject.testBless_createObject() " {{{
...
" @covers vim_lib#base#Object#.bless
"" }}}
function! s:TestObject.testBless_setParentObject() " {{{
...
" @covers vim_lib#base#Object#.bless
"" }}}
function! s:TestObject.testBless_copyMethods() " {{{
  let s:par = s:Parent.bless()
...
"" }}}
function! s:TestObject.testNew_saveClassLink() " {{{
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_saveParentObject() " {{{
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_initialization() " {{{
  let l:obj = s:Child.new(1, 2)
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_createObject() " {{{
  let l:obj = s:Child.new(1, 2)
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_initializationComplexStructure() " {{{
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_copyMethodLinks() " {{{
  let l:obj = s:Parent.new(1)
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_noSaveMethodsLink() " {{{
  let l:a = s:Child.new(1, 2)
...
" @covers vim_lib#base#Object#.new
"" }}}
function! s:TestObject.testNew_definedSubclass() " {{{
...
"" }}}
function! s:TestObject.testTypeof() " {{{
  let l:obj = s:Child.new(1, 2)
